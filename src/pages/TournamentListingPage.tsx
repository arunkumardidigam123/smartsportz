...
import { EnterpriseDiscoveryHub } from './EnterpriseDiscoveryHub';
import { LiveTournamentsHub } from './LiveTournamentsHub';
  ...
  return (
    <div className="bg-[#f8f9ff] text-[#0b1c30] min-h-screen">
      ...
      <section className="max-w-[1280px] mx-auto px-6 md:px-10 py-10">
        {activeTab === 'upcoming' ? (
          <EnterpriseDiscoveryHub isInline />
        ) : activeTab === 'live' ? (
          <LiveTournamentsHub isInline />
